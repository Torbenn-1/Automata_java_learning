...
public class DataDrivem {
    ...
    public void deveValidarRegras(){
        ...
        if(comidas.contains("Carne")) page.ComidaFavoritaCarne();
        if(comidas.contains("Pizza")) page.ComidaFavoritaPizza();
        if(comidas.contains("Vegetariano")) page.ComidaFavoritaVegetariano();
        page.setEsportes(esportes);
        page.cadastrar();
        System.out.println(msg);
        Assert.assertEquals(msg, dsl.texto_alert_accept());
    }
}
